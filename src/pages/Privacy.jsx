    ...
    <section className="rx-section" style={{ borderBottom: "none" }}>
      ...
      <div className="rx-wrap">
        ...
        <p className="rx-lead" style={{ marginTop: 20 }}>
          Last updated: August 26, 2026. This policy explains what personal information Reactive
        ...
        <div style={{ maxWidth: 760, marginTop: 48 }}>
          ...
          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>3. SMS &amp; text messaging</h2>
          <p style={{ marginBottom: 12 }}>
            Where we have your mobile phone number on file, we may use it to send text messages
            relating to an inquiry, project, or engagement you have with us — including replies to
            questions you've sent, appointment or call reminders, and project status updates. These
            messages are transactional and customer-service in nature; we do not send SMS marketing
            or promotional messages.
          </p>
          <p style={{ marginBottom: 12 }}>
            We limit text communications to numbers connected to an inquiry or engagement you have
            initiated with us; we do not send unsolicited texts. Message frequency varies depending
            on your project. Message and data rates may apply. You may opt out at any time by
            replying <strong>STOP</strong> to any message, or reply <strong>HELP</strong> for
            assistance. You may also request removal from SMS communications through the{" "}
            <a href="/contact">contact page</a>.
          </p>
          <p style={{ marginBottom: 12 }}>
            <span style={{ color: "var(--color-pink)" }}>
              No mobile information 
            </span>{" "}
              — including text messaging originator opt-in data and consent —
            <span style={{ color: "var(--color-pink)" }}>
              is shared with third parties or affiliates for marketing or promotional purposes. No
          ...
          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>5. Data storage &amp; retention</h2>
          <p style={{ marginBottom: 12 }}>
          ...
          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>6. Cookies &amp; tracking</h2>
          <p style={{ marginBottom: 12 }}>
            ...
            page, as described in Section 4.
          </p>

          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>7. Security</h2>
          <p style={{ marginBottom: 12 }}>
          ...
          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>8. Your choices</h2>
          <p style={{ marginBottom: 12 }}>
          ...
          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>9. Children's privacy</h2>
          <p style={{ marginBottom: 12 }}>
          ...
          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>10. Changes to this policy</h2>
          <p style={{ marginBottom: 12 }}>
          ...
          <h2 className="rx-h3" style={{ marginBottom: 8, marginTop: 36 }}>11. Contact</h2>
          <p style={{ marginBottom: 12 }}>
